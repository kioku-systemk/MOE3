...
--	{demotime=demotime["5b3"], scene="breakbox", scenetime={p5[2][1]+0.5*p5[2][3]-0.200,p5[2][1]+0.75*p5[2][3]      }, camera="CameraA"  },
	...
	{demotime=demotime["6a1"],    scenetime={fpart6[1][1],fpart6[1][2]},scene="transsphere", camera="CameraA", vec4={p1="0.1,2.5,0,0"}},
	{demotime=demotime["6a2"],    scenetime={fpart6[2][1],fpart6[2][2]},scene="transsphere", camera="CameraA", vec4={p1="0.1,2.5,0,0"}},
	{demotime=demotime["6a3"],    scenetime={fpart6[3][1],fpart6[3][2]},scene="transsphere", camera="CameraA", vec4={p1="0.1,2.5,0,0"}},	
	...
	{demotime=demotime["8a3"],    scenetime={fpart8[3][1],fpart8[3][2]},scene="boxstageandline",camera="Camera"  ,vec4={p1="0,0,0,1"}},	
	{demotime=demotime["8b1"],    scenetime={fpart8[4][1],fpart8[4][2]},scene="boxstageandline",camera="CameraC" ,vec4={p1="0,0,0,0.5"}},
	{demotime=demotime["8b2"],    scenetime={fpart8[5][1],fpart8[5][2]},scene="boxstageandline",camera="Camera"  ,vec4={p1="0,0,0,0.5"}},
	{demotime=demotime["8b3"],    scenetime={fpart8[6][1],fpart8[6][2]},scene="boxstageandline",camera="CameraB" ,vec4={p1="0,0,0,1"}},	
